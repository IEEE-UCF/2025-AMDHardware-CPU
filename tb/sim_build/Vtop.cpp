...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , imem_ready{vlSymsp->TOP.imem_ready}
    , dmem_read{vlSymsp->TOP.dmem_read}
    , dmem_write{vlSymsp->TOP.dmem_write}
    , dmem_ready{vlSymsp->TOP.dmem_ready}
    , pipeline_stall{vlSymsp->TOP.pipeline_stall}
    , imem_data{vlSymsp->TOP.imem_data}
    , debug_inst{vlSymsp->TOP.debug_inst}
    , imem_addr{vlSymsp->TOP.imem_addr}
    , dmem_addr{vlSymsp->TOP.dmem_addr}
    , dmem_write_data{vlSymsp->TOP.dmem_write_data}
    , dmem_read_data{vlSymsp->TOP.dmem_read_data}
